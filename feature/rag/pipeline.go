...
// are indexed with BM25 for keyword search (see foundation/bm25 and
// feature/rag/hybrid.go) and optionally with dense embeddings (via OpenAI
// Embeddings API) for semantic search. Retrieved chunks are prepended to the
// LLM context to ground responses in facts. This is a reference
